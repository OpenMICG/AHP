...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes,
        ...
        if reference_points.shape[-1] == 2:
            ...
            # print("reference_points[:, :, None, :, None, :].shape:",reference_points[:, :, None, :, None, :].shape)
            # print("sampling_offsets.shape:",sampling_offsets.shape)
            # print("offset_normalizer[None, None, None, :, None, :].shape:",offset_normalizer[None, None, None, :, None, :].shape)
